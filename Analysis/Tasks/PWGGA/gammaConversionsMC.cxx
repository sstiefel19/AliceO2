...
struct GammaConversionsMC {
               ...
               aod::McParticles const& theMcParticles)
  {
    for (auto& lV0 : theV0s) {
      ...
      fillHistogramsAfterCuts(lV0, lTrackPos, lTrackNeg, lPsiPair, lV0CosinePA);
  ...
  void fillHistogramsAfterCuts(const TV0 &theV0, const TTRACK &theTrackPos, const TTRACK &theTrackNeg, float thePsiPair, float theV0CosinePA)
  {
